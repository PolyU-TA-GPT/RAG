...
def test():
    ...
    #query_text = "What are available summer exchange institutions located in Singapore? Please also tell me requirements about them."
    ...
    with open ("{}/assets/context/{}_{}.json".format(cur_dir, collection_name, str(uuid.uuid4())).format(), 'w') as retrieval:
        json.dump(query_result, context, indent=4)
