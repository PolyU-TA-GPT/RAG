...
##### TO BE REMOVED (NOT related to Retriever Class) #####
# import sys
# sys.path.append('/../..')
import torch
import time
...
os.environ['OPENROUTER_API_KEY'] = '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'
...
def load_split_pdf(filepath: str) :
    ...
    # print("The num of pages is: ", len(document))
    for page in document:
        docs.append(page.get_text(sort=True))
...
def test():
    ...
    # 第一步，在创建新的用户的时候，将所有的pdf以及txt进行分割并进行embedding
    ...
    with open ("{}/assets/context/{}_{}.txt".format(cur_dir, collection_name, str(uuid.uuid4())).format(), 'w') as context_file:
